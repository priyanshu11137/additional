...
# Set the directory name to the location of this script
...
def generate_data(im_path, min_size, max_size):
    print(f"Attempting to open: {im_path}")
    ...
    # Filter points that are out of the image boundaries
    ...
    for phase in ['Train', 'Test']:
        ...
        if phase == 'Train':
            ...
            for sub_phase in sub_phase_list:
                ...
                # Read the file list for training phase
...
# The main function will be called from another file, so do not include the if __nam