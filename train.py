...
from train_helper_ucf import TrainerWithKFold
...
def parse_args():
    ...
    parser.add_argument('--dataset', default='qnrf', help='dataset name: qnrf, nwpu, sha, shb,cc')
